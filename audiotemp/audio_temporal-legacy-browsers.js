...
function experimentInit() {
  ...
  welcomeText = new visual.TextStim({
    win: psychoJS.window,
    name: 'welcomeText',
    text: 'In this experiment, you will hear two pairs of AUDITORY stimuli presented one after the other. \n\nYou will be asked to indicate whether the 2nd pair of stimuli was separated by a duration that was shorter or longer than the 1st pair.  Please make your decision using the Left or Right Arrow keys. \n\nPress Right Arrow to start experiment.',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0], height: 0.05,  wrapWidth: undefined, ori: 0,
    color: new util.Color('white'),  opacity: 1,
  ...
  instruction_3 = new visual.TextStim({
    win: psychoJS.window,
    name: 'instruction_3',
    text: '\nWas the 2nd pair of stimuli separated by a shorter or longer duration than the 1st pair?\n\nshorter=Left Arrow  longer=Right Arrow',
    font: 'Arial',
    units: undefined, 
